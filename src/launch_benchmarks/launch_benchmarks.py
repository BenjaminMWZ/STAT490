...
import sys
sys.path.append(".")
# sys.path.append("/Users/benjaminmao/Desktop/Rice/Sophomore_Second_Semester/STAT RA/tabular-benchmark/src/configs")  # Add the path to the configs module
from src.configs.wandb_config import wandb_id
from src.configs.all_model_configs import total_config
import argparse
import openml
import numpy as np
...
if __name__ == "__main__":
    ...
    df.to_csv(f"src/launch_benchmarks/sweeps/{output_filename}", index=False)
